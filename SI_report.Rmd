...
X<- X%>% mutate_if(is.numeric, list(mystd))
#OPTION 1 RFE
selected<-c("age","waist_circumference","bmi","systolic_pressure", "weekly_vigorous_activity","smoking" , "grain","diastolic_pressure","sex","meat_and_pou","vegetable","unsaturated_spreads_oils","water")
X<-X%>% select(selected)
y<-Y$CVD_cat_fac # y is binary class
